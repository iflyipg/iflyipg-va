...
@section('content')
      ...
      @if($stats_pirep)
        <ul class="nav nav-pills nav-fill nav-justify mb-2" id="leaderboard-pills" role="tablist">
          <li class="nav-item px-1" role="presentation">
            <button class="nav-link active p-1" id="pl-month-tab" data-bs-toggle="pill" data-bs-target="#pl-month" type="button" role="tab" aria-controls="pl-month" aria-selected="false">@lang('DBasic::widgets.lb_month_p')</button>
          </li>
          <li class="nav-item px-1" role="presentation">
          ...
          <li class="nav-item px-1 mb-1" role="presentation">
            <button class="nav-link p-1" id="overall-tab" data-bs-toggle="pill" data-bs-target="#overall" type="button" role="tab" aria-controls="overall" aria-selected="true">@lang('DBasic::widgets.lb_overall')</button>
          </li>
        </ul>
      @endif
    </div>
  ...
  @if($stats_pirep)
    <div class="tab-content" id="leaderboard-Content">
      ...
      <div class="tab-pane fade show active" id="pl-month" role="tabpanel" aria-labelledby="pl-month-tab">
