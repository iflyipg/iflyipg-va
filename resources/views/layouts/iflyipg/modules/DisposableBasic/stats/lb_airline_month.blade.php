...
<div class="row row-cols-md-2 row-cols-lg-4">
  ...
  <div class="col-md">
    @widget('DBasic::LeaderBoard', ['source' => 'airline', 'period' => 'currentm', 'count' => 5, 'type' => 'lrate_low'])
    @widget('DBasic::LeaderBoard', ['source' => 'airline', 'period' => 'lastm', 'count' => 3, 'type' => 'lrate_low'])
  </div>
</div>
