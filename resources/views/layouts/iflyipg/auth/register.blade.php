          ...
          <div class="card-footer p-0 table-responsive">
            <table class="table table-sm table-borderless align-middle mb-0">
              <tr>
                ...
                <td>
{{-- Abuelo007X: Adding this text on the acceptance option --}}
                  <label for="toc_accepted" class="control-label">@lang('auth.tocaccept')<br>
                    Including the GDPR regulations and explicitly giving permission to store the data voluntarily provided to us, as stated in our Terms and Conditions Policy (under General Data Protection Law)
                  </label>
                </td>
              </tr>
              <tr>
